                        ...
                        if is_delivered:
                            ...
                            if d_sortie and str(d_sortie).strip() not in ["", "---", "None"]:
                                ...
                                if w:
                                    ...
                                    # ملاحظة: سطر الـ st.markdown يبقى مزاحاً حسب بايثون
                                    # لكن النص داخله (HTML) يبدأ من بداية السطر لضمان السلامة
                                    st.markdown(f"""
<div style="margin-bottom: 15px; border: 1px solid #444c56; padding: 12px; border-radius: 10px; background: rgba(255, 215, 0, 0.05); direction: rtl; text-align: right;">
    <div style="display: flex; justify-content: space-between; margin-bottom: 8px; align-items: center; direction: rtl;">
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 8px; direction: rtl;">
